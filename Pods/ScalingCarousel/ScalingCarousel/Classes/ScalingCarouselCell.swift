...
open class ScalingCarouselCell: UICollectionViewCell {
    ...
    @IBOutlet public var restaurantPic: UIImageView!
    @IBOutlet public var restaurantName: UILabel!
    @IBOutlet public var restaurantRating: UILabel!
    @IBOutlet public var restaurantPriceLevel: UILabel!
    @IBOutlet public var starRating: CosmosView!
    @IBOutlet public var restaurantDistance: UILabel!
    @IBOutlet public var restaurantPrice: UILabel!
    
    
    @IBOutlet public var menuButton: UIButton!
    
    @IBOutlet public var mapButton: UIButton!
    @IBOutlet public var phoneButton: UIButton!
